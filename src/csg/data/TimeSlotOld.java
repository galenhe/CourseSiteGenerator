...
//    private HashMap<DayOfWeek, ArrayList<TeachingAssistantPrototypeOld>> tas;
//    private HashMap<DayOfWeek, StringProperty> dayText;
//
//    public TimeSlotOld(String initStartTime, String initEndTime) {
...
//
//    // SERVICE METHODS
//    public void addTA(DayOfWeek dow, TeachingAssistantPrototypeOld ta) {
//        ArrayList<TeachingAssistantPrototypeOld> tasList = tas.get(dow);
...
//    }
//
//    public void removeTA(DayOfWeek dow, TeachingAssistantPrototypeOld ta) {
//        ArrayList<TeachingAssistantPrototypeOld> tasList = tas.get(dow);
//        TAType currentType = TAType.valueOf(ta.getType());
//        if (tasList.contains(ta)) {
//            tasList.remove(ta);
...
//        ArrayList<TeachingAssistantPrototypeOld> taList = this.tas.get(dow);
//        String taText = "";
//        int counter = 0;
//        for (TeachingAssistantPrototypeOld ta : taList) {
...
//    }
//
//    public void toggleTA(DayOfWeek dow, TeachingAssistantPrototypeOld ta) {
//        ArrayList<TeachingAssistantPrototypeOld> taList = tas.get(dow);
...
//    }
//
//    public Iterator<TeachingAssistantPrototypeOld> getTAsIterator(DayOfWeek dow) {
//        return tas.get(dow).iterator();
//    }
//    
//    public boolean hasTA(TeachingAssistantPrototypeOld ta, DayOfWeek dow) {
//        return tas.get(dow).contains(ta);
//    }
//    
//    public boolean hasTA(TeachingAssistantPrototypeOld ta) {
//        for (DayOfWeek dow : DayOfWeek.values()) {
//            if (hasTA(ta, dow))
//                return true;
//        }
...
//    }
//
//    public ArrayList<DayOfWeek> getDaysForTA(TeachingAssistantPrototypeOld ta) {
//        if (!hasTA(ta)) {
//            return null;
//        }
//        else {
