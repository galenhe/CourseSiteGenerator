...
// */
//public class TeachingAssistantPrototypeOld<E extends Comparable<E>> implements Comparable<E>  {
...
//     */
//    public TeachingAssistantPrototypeOld(String initName, String initEmail, TAType initType) {
...
//        return getName().compareTo(((TeachingAssistantPrototypeOld)otherTA).getName());
//    }
//    
//    @Override
...
//        return name.getValue().toLowerCase().equals(((TeachingAssistantPrototypeOld)testTA).name.getValue().toLowerCase().trim())
//                || email.getValue().toLowerCase().equals(((TeachingAssistantPrototypeOld)testTA).email.getValue().toLowerCase().trim());
//    }
//
...
//    
//    public E clone() {
//        TeachingAssistantPrototypeOld ta = new TeachingAssistantPrototypeOld(
